        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    @endif
                    <form method="POST" class="form-horizontal" action="{{ route('postclass.store') }}"
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Slug</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="{{ old('slug_post') }}" name="slug_post"
                                    id="convert_slug">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group"><label class="col-sm-2 control-label">Tóm tắt khóa học</label>
                            <div class="col-sm-8">
                                <textarea name="tomtat" id="ckeditor_shortdesc" cols="30" rows="10" class="form-control"
                                    style="resize: none">{{ old('tomtat') }}</textarea>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group"><label class="col-sm-2 control-label">Nội dung khóa học</label>
                            <div class="col-sm-8">
                                <textarea name="noidung" id="ckeditor_noidung" cols="30" rows="10" class="form-control"
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Số lượng học viên</label>
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="Soluonghocvien"  value="{{ old('Soluonghocvien') }}" >
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Môn học</label>
                            <div class="col-sm-8">
                                <select class="form-control m-b" name="id_monhoc">
                                    ...
                                    <option {{ $values->kichhoat==1?'hidden':''}} value="{{ $values->id }}">
                                        {{ $values->tenmonhoc }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Lịch khai giảng</label>
                            <div class="col-sm-8">
                                <input type="date" class="form-control" value="{{ old('lichkhaigiang') }}"
                                    name="lichkhaigiang">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
